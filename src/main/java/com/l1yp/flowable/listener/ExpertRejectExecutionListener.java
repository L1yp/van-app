...
public class ExpertRejectExecutionListener implements ExecutionListener {
    ...
    public void notify(DelegateExecution execution) {
        ...
        Number count = (Number) processModelMapper.findFieldByWFID(tableName, wfId, "expert_reject_count");
        processModelMapper.updateFields(tableName, wfId, null, Map.of("expert_reject_count", count.intValue() + 1));
