...
public interface ModelingViewMapper extends BaseMapper<ModelingView> {
    ...
    @Results({
            ...
            @Result(property = "update_by", column = "update_by", jdbcType = JdbcType.BIGINT, javaType = String.class),
            @Result(property = "create_by", column = "create_by", jdbcType = JdbcType.BIGINT, javaType = String.class),
    })
