...
INSERT INTO `ACT_HI_DETAIL` VALUES ('9f2b2ece-e57e-11ec-87e2-d8bbc132d9b2','VariableUpdate','9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2','9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',NULL,NULL,'creator','string',0,'2022-06-06 17:54:14.069',NULL,NULL,NULL,'1',NULL);
...
INSERT INTO `ACT_HI_PROCINST` VALUES ('9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',2,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2','1','zhicheng:1:97d129eb-e57e-11ec-87e2-d8bbc132d9b2','2022-06-06 17:54:14.068','2022-06-06 17:54:31.617',17549,'1','StartEvent_1iig6c2','Event_1kud1qc',NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `ACT_HI_VARINST` VALUES ('9f2b07bd-e57e-11ec-87e2-d8bbc132d9b2',0,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2','9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',NULL,'creator','string',NULL,NULL,NULL,NULL,NULL,NULL,'1',NULL,'2022-06-06 17:54:14.069','2022-06-06 17:54:14.069');
...
INSERT INTO `ACT_RE_DEPLOYMENT` VALUES ('97c1c099-e57e-11ec-87e2-d8bbc132d9b2','职称申请流程','https://l1yp.com/docs/flowable/bpmn/','zhicheng','','2022-06-06 09:54:01.634',NULL,NULL,'97c1c099-e57e-11ec-87e2-d8bbc132d9b2',NULL);
...
INSERT INTO `ACT_RE_PROCDEF` VALUES ('zhicheng:1:97d129eb-e57e-11ec-87e2-d8bbc132d9b2',1,'http://www.flowable.org/processdef','职称评审流程','zhicheng',1,'97c1c099-e57e-11ec-87e2-d8bbc132d9b2','zhicheng.bpmn20.xml',NULL,'用于职称评审的流程哈哈',0,1,1,'',NULL,NULL,NULL,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='页面配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=376 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='角色菜单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role_menu` VALUES (288,2,1,'admin'),(289,2,3,'admin'),(290,2,4,'admin'),(291,2,5,'admin'),(292,2,7,'admin'),(293,2,8,'admin'),(294,2,12,'admin'),(295,2,14,'admin'),(296,2,23,'admin'),(297,2,25,'admin'),(298,2,28,'admin'),(299,2,29,'admin'),(300,2,30,'admin'),(301,2,31,'admin'),(302,2,32,'admin'),(303,2,33,'admin'),(359,1,1,'admin'),(360,1,3,'admin'),(361,1,4,'admin'),(362,1,5,'admin'),(363,1,7,'admin'),(364,1,8,'admin'),(365,1,12,'admin'),(366,1,14,'admin'),(367,1,23,'admin'),(368,1,29,'admin'),(369,1,30,'admin'),(370,1,31,'admin'),(371,1,32,'admin'),(372,1,33,'admin'),(373,1,34,'admin'),(374,1,35,'admin'),(375,1,36,'admin');
...
CREATE TABLE `sys_user_role` (
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='用户角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wf_field_user` VALUES (1,'zhicheng',1,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',33,2,'admin','2022-06-06 17:54:14','2022-06-06 17:54:14'),(2,'zhicheng',1,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',33,3,'admin','2022-06-06 17:54:14','2022-06-06 17:54:14'),(3,'zhicheng',1,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',33,4,'admin','2022-06-06 17:54:14','2022-06-06 17:54:14'),(4,'zhicheng',1,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',33,5,'admin','2022-06-06 17:54:14','2022-06-06 17:54:14'),(5,'zhicheng',1,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',33,6,'admin','2022-06-06 17:54:14','2022-06-06 17:54:14'),(6,'zhicheng',1,'9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2',33,7,'admin','2022-06-06 17:54:14','2022-06-06 17:54:14');
...
CREATE TABLE `wf_zhicheng` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `process_bpmn_id` bigint NOT NULL DEFAULT '0' COMMENT '流程版本ID',
  `process_definition_id` varchar(128) COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '流程定义ID',
  ...
  `creator` bigint NOT NULL,
  `update_by` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `judges` varchar(128) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '评委用户列表',
...
INSERT INTO `wf_zhicheng` VALUES (1,20,'zhicheng:1:97d129eb-e57e-11ec-87e2-d8bbc132d9b2','9f2b07bc-e57e-11ec-87e2-d8bbc132d9b2','ZL2022060600001','测试 退回',1,'1','2022-06-06 17:54:30','2022-06-06 17:54:14','2,3,4,5,6,7',NULL,0,2);
...
-- Dump completed on 2022-06-06 17:54:47
