...
INSERT INTO `modeling_view` VALUES (1594323506409889794,'ENTITY','product_line','基本视图','[{\"id\": 0, \"field\": \"update_time\", \"order\": \"desc\"}]',1,1,1,'2022-11-21 09:13:53',1,'2022-11-20 21:35:20');
...
CREATE TABLE `wf_holiday` (
  ...
  `process_instance_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '流程实例ID',
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` bigint unsigned NOT NULL COMMENT '更新人',
  `update_time` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '更新时间',
  `cost_center` bigint unsigned DEFAULT NULL COMMENT 'cost_center',
...
-- Dump completed on 2022-11-21 16:01:47
